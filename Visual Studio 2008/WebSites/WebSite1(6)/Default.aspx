...
<body>
    ...
    <div>
                        ...
                        <cc1:TabPanel ID="Tab1" runat="server" HeaderText="Travel">
                            <ContentTemplate>
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Button ID="btnNext" runat="server" Text="Next" CausesValidation="false" OnClick="TravelTabNext1" />
                                        </td>
                                    </tr>
                                </table>
                            </ContentTemplate>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Button ID="btnPrevious" runat="server" Text="Prev" CausesValidation="false"
                                                OnClick="TravelTabPrev1" />
                                        </td>
                                        <td style="text-align: right">
                                            <asp:Button ID="btnNext1" runat="server" Text="Next" CausesValidation="false" OnClick="TravelTabNext2" />
                                        </td>
                                    </tr>
                                </table>
                            </ContentTemplate>
                            ...
                            <ContentTemplate>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Button ID="btnReset" runat="server" Text="Reset" CausesValidation="false" OnClick="TravelReset" />
                                        </td>
                                    </tr>
                                </table>
                            </ContentTemplate>
        ...
        <table>
            <tr>
                <td>
                    <asp:GridView ID="TravelGrid" runat="server">
                    </asp:GridView>
                </td>
            </tr>
        </table>
