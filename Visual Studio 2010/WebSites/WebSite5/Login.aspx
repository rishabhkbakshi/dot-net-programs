...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="text-align: center; background-color: Silver" class="style1">
        <table align="center">
            <tr>
                <td>
                    <asp:Label ID="lblLogin" runat="server" Text="Login" Font-Size="XX-Large" Font-Underline="true"></asp:Label>
                </td>
            </tr>
        </table>
        <table align="center">
        ...
        <table align="center">
            <tr>
                <td>
                    <asp:Button ID="btnlogin" runat="server" Text="Submit" OnClick="btnlogin_Click" CssClass="input_button" />
                </td>
            </tr>
            <tr>
                <td>
