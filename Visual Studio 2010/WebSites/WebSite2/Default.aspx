...
<body>
    ...
    <div>
        ...
        <table>
            <tr>
                <td>
                    <asp:GridView ID="RecordGrid" runat="server" AutoGenerateColumns="false" 
                        DataKeyNames="Id" onrowdeleting="RecordGrid_RowDeleting" 
                        onrowupdating="RecordGrid_RowUpdating">
                        <Columns>
