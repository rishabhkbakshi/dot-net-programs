    ...
    <form id="form1" runat="server">
        <div>
            <table>
                ...
                <tr>
                    <td>
                        <asp:RadioButton ID="rbtn" runat="server" AutoPostBack="true" />
                    </td>
                </tr>
            </table>
            <table style="border: 1; border-color: Black; border-style: solid; border-width: thin; padding: 2;">
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:Label ID="lblBindFirstname" runat="server" Text='<%Bind("Firstname") %>'></asp:Label>
                    </td>
                    <td>
                        <asp:Label ID="lblBindLastname" runat="server" Text='<%Bind("Lastname") %>'></asp:Label>
                    </td>
                    <td>
